...
<NavBar/>
  ...
  {/*contact js*/}
  <style>{`
        /* Style only the select dropdowns in the form */
        .form-element-section select {
          width: 100%;
          padding: 12px 18px;
          ...
          font-family: inherit;
          font-weight: 600;
          box-shadow: 0 2px 8px rgba(255,94,19,0.07);
          transition: border 0.2s, box-shadow 0.2s;
        }
        .form-element-section select:focus {
          outline: none;
          border: 2.5px solid #eb6b55;
          background: #fff;
          box-shadow: 0 4px 16px rgba(255,94,19,0.13);
        }
        .form-element-section option {
          color: #191d34;
          font-weight: 500;
        }
      `}</style>
